...
//!
//! ## Strings
//! Next are the **[strings](https://gist.github.com/sliminality/dab21fa834eae0a70193c7cd69c356d5#strings-section)**, which include the "metadata" for the [puzzle](crate::Puzzle), such as its [title](crate::Puzzle::title) and [author](crate::Puzzle::author).
...
//! }
//! ```
//! When `strict` reading is enabled, all checksums need to be valid in order to successfully parse a [puzzle](crate::Puzzle).
...
//!
//! ### File
//! Next is the **file checksum** checks all data used for the [puzzle](crate::Puzzle), i.e. both [puzzle grids](self#puzzle-grid) and all [strings](self#strings).
