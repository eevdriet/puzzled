...
/// ```
/// use puzzled_cross::{square, Square, cell};
///
/// assert_eq!(square!(), Square::Black);
/// assert_eq!(square!(.), Square::Black);
/// assert_eq!(square!('L'), Square::White(cell!('L')));
/// assert_eq!(square!("Rebus"), Square::White(cell!("Rebus")));
///
/// // Invalid syntax
/// // square!(9)
/// // square!(L)
...
///
/// Cells can be constructed a 2 different ways
